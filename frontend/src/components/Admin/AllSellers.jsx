...
const AllSellers = () => {
  ...
  const handleRevenueClick = (sellerId) => {
    // Redirect to a new page showing all orders and their total cost for the selected seller
    // You can use React Router to navigate to the new page
    // Example:
    // history.push(`/seller-revenue/${sellerId}`);
  };
    ...
    { field: "joinedAt", headerName: "joinedAt", type: "text", minWidth: 130, flex: 0.8 },
    {
      ...
      renderCell: (params) => {
        return (
          ...
          //   variant="contained"
          //   color="primary"
          //   onClick={() => handleRevenueClick(params.id)}
          // >
          //   View Revenue
          // </Button>
          <Link to={`/shop/Revenue/${params.id}`}>
          <Button>
            Revenue
          </Button>
        </Link>
